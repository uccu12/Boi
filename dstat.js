...
if (!reqmethod || !target || !time || !threads || !ratelimit || !proxyfile) {
    console.clear();
    console.error(`
    cf v1 Method With RST STREAM (CVE-2023-44487) // Updated: 01.06.2025 // With love @bypasiing
    Developers to method: @bypasiing - developer method // @bypasiing - recoding method
    How to use & example:
